...
filePath <- "E:\\datascience\\datasciencecoursera\\DataScience\\Course 10\\Capstone\\Week 2"
...
Now time to do some exploratory analysis on the data. It would be interesting and helpful to find the most frequently occurring words in the data. Here we list the most common (n-grams) uni-grams, bi-grams, and tri-grams.
