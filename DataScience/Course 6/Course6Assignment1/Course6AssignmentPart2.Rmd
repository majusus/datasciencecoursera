---
title: "Course 6 Project - Statistical Inference - Part 2"
author: "majusus"
date: "April 7, 2019"
output:   
...
We went through all possible combinations of levels from the factor variable dose and in all cases the p-value is lower than the default signficance level **0.05**. Thus, we conclude there appears to be a positive relationship between dose level and teeth length.
